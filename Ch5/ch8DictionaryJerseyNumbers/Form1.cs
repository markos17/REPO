...
namespace ch8DictionaryJerseyNumbers
{
    public partial class Form1 : Form
    {
        ...
        private void cbNr_SelectedIndexChanged(object sender, EventArgs e)
        {
            JerseyNumber jerseyNr = retiredNumbers[(int)cbNr.SelectedIndex];
            lbName.Text = jerseyNr.Player;
            lbYear.Text = jerseyNr.YearRetired.ToString();
        }
    }
}
